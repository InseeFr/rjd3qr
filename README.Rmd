...
[![Linting code](https://github.com/InseeFr/rjd3qr/actions/workflows/lint.yml/badge.svg)](https://github.com/InseeFr/rjd3qr/actions/workflows/lint.yml)
...
Pour cela, il faut modifier l'option `"rjd3qr.thresholds"`.
...
Pour plus d'informations sur l'installation et la configuration du package **{rjd3qr}**, vous pouvez visiter la page [wiki](https://github.com/jdemetra/jwsacruncher/wiki)
...
You have to modify the option `"rjd3qr.thresholds"`.
...
For more informations on installing and configuring the **{rjd3qr}** package, you can visit the [wiki](https://github.com/jdemetra/jwsacruncher/wiki) page.
